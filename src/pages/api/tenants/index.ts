...
let tenants = [
  { id: "demo-company-123", name: "Demo Company", status: "ACTIVE", createdAt: new Date().toISOString() }
]
export default function handler(req: NextApiRequest, res: NextApiResponse){
  ...
  if(req.method === "POST"){
    ...
    const newTenant = { id, name, status: "ACTIVE", createdAt: new Date().toISOString() }
